...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleSignInButton = findViewById(R.id.btnLoginGoogle);
    ...
    private void onLoggedIn(GoogleSignInAccount googleSignInAccount) {
        Intent intent = new Intent(this, UsuarioFragment.class);
    //    intent.putExtra(UsuarioFragment.GOOGLE_ACCOUNT, googleSignInAccount);
